    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 select-none">
      ...
      <div className="p-5 rounded-2xl bg-white border border-slate-200/80 shadow-xs flex flex-col">
        ...
        <div className="mt-3 space-y-2 flex-1">
          {tickets.length === 0 ? (
            <p className="text-xs text-slate-400 italic p-6 text-center">No hay tickets de soporte técnico registrados.</p>
          ) : (
      ...
      <div className="p-5 rounded-2xl bg-white border border-slate-200/80 shadow-xs flex flex-col">
        ...
        <div className="mt-3 space-y-2 flex-1 overflow-y-auto max-h-48">
          {auditLogs.length === 0 ? (
            <p className="text-xs text-slate-400 italic p-6 text-center">No hay registros de auditoría aún.</p>
          ) : (
