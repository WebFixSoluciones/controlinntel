...
const NAV_ITEMS = [
  ...
  { href: "/finanzas", label: "Finanzas & Pre-SRI", icon: DollarSign, badge: "M5" },
    ...
    <aside className="w-64 bg-white border-r border-slate-200 flex flex-col flex-shrink-0 min-h-screen select-none">
      ...
      <div className="p-3 border-t border-slate-100 bg-slate-50/70">
        <div className="flex items-center justify-between p-2 rounded-xl bg-white border border-slate-200/80 shadow-xs">
          <div className="flex items-center gap-2.5 min-w-0">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-sky-600 to-purple-600 text-white font-bold text-xs flex items-center justify-center shadow-xs flex-shrink-0">
